...
func main() {
	...
	r.HandleFunc("/api/addProduct", addProductHandler)
	r.HandleFunc("/api/listProducts", listProductsHandler)
	r.HandleFunc("/api/filterProducts", filterProductHandler)
	r.HandleFunc("/api/filterOptions", filterOptionsHandler)
